    ...
    return (
        <div className={classes.region}>
            ...
            <div className={classes.regionInfo}>
                <span className={classes.title}>{region.name.charAt(0).toUpperCase() + region.name.slice(1)}</span>
                <span className={classes.server}>on {region.server.charAt(0).toUpperCase() + region.server.slice(1)}</span>

        ...
        <div className={classes.container}>
            <div className={classes.box}>
                ...
                <div className={classes.lower}>
                    <span>Lower</span>
                    <span className={classes.coords}>{region.iBounds.x}, {region.iBounds.y}, {region.iBounds.z}</span>
                </div>
                <div className={classes.upper}>
                    <span>Upper</span>
                    <span className={classes.coords}>{region.oBounds.x}, {region.oBounds.y}, {region.oBounds.z}</span>
                </div>
            </div>

            <div className={classes.box2}>
                <div className={classes.lastUpdated}>Last Updated</div>
                <div className={classes.lastUpdatedTime}>{getTimeUpdatedAgo(region.lastUpdated)}</div>
            </div>
        </div>
    )
}
